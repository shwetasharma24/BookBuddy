...
export default function AddBook() {
    ...
    const handleSaveBook = (book) => {
        if (!book.rating) return handleOpenSnackbar({ isSaved: false, message: "Rate the book" });
    ...
    return (
        <>
            ...
            <Grid alignContent="center" container className={classes.root} spacing={1}>
                <Grid container item xs={12} md={6} spacing={2}>
                    ...
                    <Grid item xs={12}>
                        <Button variant="contained" color="primary" onClick={() => handleSaveBook(book)}>
                            SAVE THE BOOK
                        </Button>
                    </Grid>
                </Grid>
            ...
            <Modal modalContent={book} isModalOpen={isModalOpen} setModalOpen={setModalOpen} />
